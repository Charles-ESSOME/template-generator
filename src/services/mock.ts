...
export const template: TemplatesEmail = {
  id: `1`,
  name: 'Template test',
...
@media (max-width: 480px) { #u_content_image_1 .v-src-width { width: auto !important; }
#u_content_image_1 .v-src-max-width { max-width: 20% !important; } #u_content_heading_1 .v-font-size { font-size: 45px !important; }
#u_content_heading_2 .v-font-size { font-size: 19px !important; } #u_content_text_2 .v-font-size { font-size: 14px !important; }
#u_content_button_2 .v-text-align { text-align: center !important; } #u_content_text_3 .v-text-align { text-align: center !important; }
#u_content_text_4 .v-font-size { font-size: 18px !important; } #u_content_text_4 .v-line-height { line-height: 140% !important; }
 #u_content_text_7 .v-font-size { font-size: 18px !important; } #u_content_text_6 .v-font-size { font-size: 18px !important; }
 #u_content_text_5 .v-font-size { font-size: 18px !important; } #u_content_heading_3 .v-font-size { font-size: 28px !important; }
 #u_column_8 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; }
 #u_column_9 .v-col-border { border-top: 0px solid transparent !important;border-left: 0px solid transparent !important;border-right: 0px solid transparent !important;border-bottom: 0px solid transparent !important; }
...
<div class="v-text-align" align="right">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:40px; v-text-anchor:middle; width:69px;" arcsize="62.5%"  stroke="f" fillcolor="#0071e3"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
    <a href="" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #0071e3; border-radius: 25px;-webkit-border-radius: 25px; -moz-border-radius: 25px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 17px;">
